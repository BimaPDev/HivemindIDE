 ...
 *
 *  Drop target: src/vs/workbench/services/hivemindide/common/coordinationClient.ts
 *--------------------------------------------------------------------------*/
...
/**
 * Turns a denied lease into the sentence the editor shows the user.
 *
 * Kept next to the client rather than in the UI layer so the save-blocked
 * notification and the sidebar panel cannot drift apart.
 */
